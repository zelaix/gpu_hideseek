...
public:
    ...
    MGR_EXPORT madrona::py::Tensor agentActiveMaskTensor() const;
    MGR_EXPORT madrona::py::Tensor selfObsTensor() const;
    MGR_EXPORT madrona::py::Tensor agentObsTensor() const;
    MGR_EXPORT madrona::py::Tensor boxObsTensor() const;
    MGR_EXPORT madrona::py::Tensor rampObsTensor() const;
    MGR_EXPORT madrona::py::Tensor agentMaskTensor() const;
    MGR_EXPORT madrona::py::Tensor boxMaskTensor() const;
    MGR_EXPORT madrona::py::Tensor rampMaskTensor() const;
