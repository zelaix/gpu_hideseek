...
from gpu_hideseek_learn import LearningState
...
sim = gpu_hideseek.HideAndSeekSimulator(
    exec_mode = gpu_hideseek.madrona.ExecMode.CUDA if args.gpu_sim else gpu_hideseek.madrona.ExecMode.CPU,
    gpu_id = args.gpu_id,
...
if args.action_dump_path:
    action_dump_dir = Path(args.action_dump_path).parent
    action_dump_dir.mkdir(exist_ok=True, parents=True)
